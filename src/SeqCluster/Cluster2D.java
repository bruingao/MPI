...
/**
 * Cluster2D implements the k-means clustering algorithm.
 * The program takes in a list of 2D point locations,
...
public class Cluster2D {
    ...
    /**
     * The main function of Cluster2D.
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if(argv.length != 2)
        {
            System.out.println("Proper Usage is: java Cluster2D datafile #cluster");
            System.exit(0);
        }
        ...
        /*
         * strategy 1
         * randomly select initial centroids from the original 2D points,
        ...
        */
        ...
        while(incre>threshold){
            ...
            /* assign tag for each point according to minimum distance among centroids */
            ...
            /* compute the total difference of centroids from last iteration, see if converged */
            incre=0.0;
            for(int i=0;i<k_param;i++){
                tagXY[i][0] /= tagSize[i];
                tagXY[i][1] /= tagSize[i];
